...
# This test is simple by design. It merely ensures, that calling Guardrails does not fail with old versions.
...
echo "Guardrails should be able to run in various versions of NodeJS"
